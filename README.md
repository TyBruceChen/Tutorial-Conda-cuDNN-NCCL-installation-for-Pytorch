# Conda-Installation-Tutorial-Windows10 (for Linux (Ubuntu18), click [here](https://github.com/TyBruceChen/Tutorial-Conda-cuDNN-NCCL-installation-for-Pytorch/blob/main/README_virtual_env_Ubuntu18_server.md)) (for Pytorch distributed GPU training with NCCL (as well as by [Accelerate class](https://huggingface.co/docs/accelerate/v0.12.0/en/basic_tutorials/launch)), click [here](https://github.com/TyBruceChen/Tutorial-Conda-cuDNN-NCCL-installation-for-Pytorch/blob/main/README_nccl_distributed_compute.md))
